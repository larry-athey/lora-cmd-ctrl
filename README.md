...
Neopixel/WS2812 addressable LEDs can be controlled at the individual fixture/LED level or the entire network can change color at the same time. Power things with a decent [Mean Well](https://www.meanwell.com/) power supply and one LCC receiver module can run an entire Christmas light show. Scenes and animations can be scripted using the [Lua](https://github.com/elua/elua) programming language.
