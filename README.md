...
### Motor Control
The LCC receiver module can control standard DC brushed motors using a PWM driven H bridge such as an L298N, or stepper motors such as a Nema 17 with a DRV8825 driver.
